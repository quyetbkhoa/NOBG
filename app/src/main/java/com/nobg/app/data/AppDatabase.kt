...
@Database(entities = [AppEntity::class, BackupEntity::class, BatteryLogEntity::class, ChargingSessionEntity::class, CpuLogEntity::class], version = 5, exportSchema = false)
